## Приложение - карточка твиттера пользователя.

1. Создан макет одной карточки твиттера пользователя.
   ![Mакет одной карточки твиттера пользователя (первоначальное состояние)](./assets/one-card_false.jpg)
...
3. Результат фиксируется и после перезагрузки страницы отображается последнее
   ...
   ![Mакет одной карточки твиттера пользователя (после первого клика)](./assets/one-card_true.jpg)
